install.packages("tidytext") install.packages("tibble") install.packages("tidyverse") install.packages("wordcloud") install.packages("ggplot2") install.packages("igraph")
